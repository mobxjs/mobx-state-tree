...
test("it should create a factory", (t) => {
    ...
    t.deepEqual(getSnapshot(Factory.create()) as any, {to: 'world'}) // TODO: improve typing
...
test("it should restore the state from the snapshot", (t) => {
    ...
    t.deepEqual(getSnapshot(Factory.create({to: 'universe'})) as any, { to: 'universe' }) // TODO: improve typing
})
...
test("it should apply snapshots", (t) => {
    ...
    t.deepEqual(getSnapshot(doc) as any, {to: 'universe'})  // TODO: improve typing
})
...
test("it should compose factories", (t) => {
    ...
    // TODO: fix typecheck
    t.deepEqual(getSnapshot(ComposedFactory.create()) as any, {width: 0, height: 0, color: "#FFFFFF"})  // TODO: improve typing
})
