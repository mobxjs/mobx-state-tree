...
*Defined in [src/middlewares/createActionTrackingMiddleware2.ts:4](https://github.com/mobxjs/mobx-state-tree/blob/b34bf45a/src/middlewares/createActionTrackingMiddleware2.ts#L4)*
...
*Defined in [src/middlewares/createActionTrackingMiddleware2.ts:5](https://github.com/mobxjs/mobx-state-tree/blob/b34bf45a/src/middlewares/createActionTrackingMiddleware2.ts#L5)*
