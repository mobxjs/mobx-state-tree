...
[mobx-state-tree - v5.4.0](../index.md) › [ReferenceOptionsOnInvalidated](referenceoptionsoninvalidated.md)
...
*Defined in [src/types/utility-types/reference.ts:448](https://github.com/mobxjs/mobx-state-tree/blob/68b756ba/src/types/utility-types/reference.ts#L448)*
