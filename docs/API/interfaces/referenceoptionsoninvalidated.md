...
[mobx-state-tree - v5.0.2](../index.md) › [ReferenceOptionsOnInvalidated](referenceoptionsoninvalidated.md)
...
*Defined in [packages/mobx-state-tree/src/types/utility-types/reference.ts:470](https://github.com/mobxjs/mobx-state-tree/blob/c440e040/packages/mobx-state-tree/src/types/utility-types/reference.ts#L470)*
