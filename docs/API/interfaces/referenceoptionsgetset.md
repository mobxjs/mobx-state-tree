...
[mobx-state-tree - v5.4.0-pre.1](../index.md) › [ReferenceOptionsGetSet](referenceoptionsgetset.md)
...
*Defined in [src/types/utility-types/reference.ts:442](https://github.com/mobxjs/mobx-state-tree/blob/0694a96a/src/types/utility-types/reference.ts#L442)*
...
*Defined in [src/types/utility-types/reference.ts:443](https://github.com/mobxjs/mobx-state-tree/blob/0694a96a/src/types/utility-types/reference.ts#L443)*
