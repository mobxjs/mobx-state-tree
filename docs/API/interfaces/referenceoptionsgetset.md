...
[mobx-state-tree - v7.1.0](../index.md) › [ReferenceOptionsGetSet](referenceoptionsgetset.md)
...
*Defined in [src/types/utility-types/reference.ts:472](https://github.com/mobxjs/mobx-state-tree/blob/6c2cad97/src/types/utility-types/reference.ts#L472)*
...
*Defined in [src/types/utility-types/reference.ts:473](https://github.com/mobxjs/mobx-state-tree/blob/6c2cad97/src/types/utility-types/reference.ts#L473)*
