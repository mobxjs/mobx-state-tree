...
[mobx-state-tree - v6.0.1](../index.md) › [ReferenceOptionsGetSet](referenceoptionsgetset.md)
...
*Defined in [src/types/utility-types/reference.ts:444](https://github.com/mobxjs/mobx-state-tree/blob/7097c4d6/src/types/utility-types/reference.ts#L444)*
...
*Defined in [src/types/utility-types/reference.ts:445](https://github.com/mobxjs/mobx-state-tree/blob/7097c4d6/src/types/utility-types/reference.ts#L445)*
