...
[mobx-state-tree - v5.4.0-pre.1](../index.md) › [FunctionWithFlag](functionwithflag.md)
...
*Defined in [src/core/action.ts:42](https://github.com/mobxjs/mobx-state-tree/blob/0694a96a/src/core/action.ts#L42)*
...
*Defined in [src/core/action.ts:41](https://github.com/mobxjs/mobx-state-tree/blob/0694a96a/src/core/action.ts#L41)*
