...
[mobx-state-tree - v7.3.2](../index.md) › [FunctionWithFlag](functionwithflag.md)
...
*Defined in [src/core/action.ts:42](https://github.com/mobxjs/mobx-state-tree/blob/1f4bc725/src/core/action.ts#L42)*
...
*Defined in [src/core/action.ts:41](https://github.com/mobxjs/mobx-state-tree/blob/1f4bc725/src/core/action.ts#L41)*
