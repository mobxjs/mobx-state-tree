    ...
    expect(events).toEqual([
        {
            args: [7],
            context: {},
            id: process.env.NODE_ENV !== "production" ? 28 : 25,
            name: "a",
            parentId: 0,
            rootId: process.env.NODE_ENV !== "production" ? 28 : 25,
            tree: {},
            type: "action"
        },
        {
            args: [14],
            context: {},
            id: process.env.NODE_ENV !== "production" ? 29 : 26,
            name: "b",
            parentId: process.env.NODE_ENV !== "production" ? 28 : 25,
            rootId: process.env.NODE_ENV !== "production" ? 28 : 25,
            tree: {},
            type: "action"
        }
