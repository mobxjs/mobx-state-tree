...
// prettier-ignore
export function union<PA extends ModelProperties, OA, FCA, FSA, PB extends ModelProperties, OB, FCB, FSB>(A: IModelType<PA, OA, FCA, FSA>, B: IModelType<PB, OB, FCB, FSB>): ModelUnion<ModelCreationType<PA, FCA> | ModelCreationType<PB, FCB>, ModelSnapshotType<PA, FSA> | ModelSnapshotType<PB, FSB>, ModelInstanceType<PA, OA, FCA, FSA> | ModelInstanceType<PB, OB, FCB, FSB>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, FCA, FSA, PB extends ModelProperties, OB, FCB, FSB>(options: UnionOptions, A: IModelType<PA, OA, FCA, FSA>, B: IModelType<PB, OB, FCB, FSB>): ModelUnion<ModelCreationType<PA, FCA> | ModelCreationType<PB, FCB>, ModelSnapshotType<PA, FSA> | ModelSnapshotType<PB, FSB>, ModelInstanceType<PA, OA, FCA, FSA> | ModelInstanceType<PB, OB, FCB, FSB>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, FCA, FSA, PB extends ModelProperties, OB, FCB, FSB, PC extends ModelProperties, OC, FCC, FSC>(A: IModelType<PA, OA, FCA, FSA>, B: IModelType<PB, OB, FCB, FSB>, C: IModelType<PC, OC, FCC, FSC>): ModelUnion<ModelCreationType<PA, FCA> | ModelCreationType<PB, FCB> | ModelCreationType<PC, FCC>, ModelSnapshotType<PA, FSA> | ModelSnapshotType<PB, FSB> | ModelSnapshotType<PC, FSC>, ModelInstanceType<PA, OA, FCA, FSA> | ModelInstanceType<PB, OB, FCB, FSB> | ModelInstanceType<PC, OC, FCC, FSC>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, FCA, FSA, PB extends ModelProperties, OB, FCB, FSB, PC extends ModelProperties, OC, FCC, FSC>(options: UnionOptions, A: IModelType<PA, OA, FCA, FSA>, B: IModelType<PB, OB, FCB, FSB>, C: IModelType<PC, OC, FCC, FSC>): ModelUnion<ModelCreationType<PA, FCA> | ModelCreationType<PB, FCB> | ModelCreationType<PC, FCC>, ModelSnapshotType<PA, FSA> | ModelSnapshotType<PB, FSB> | ModelSnapshotType<PC, FSC>, ModelInstanceType<PA, OA, FCA, FSA> | ModelInstanceType<PB, OB, FCB, FSB> | ModelInstanceType<PC, OC, FCC, FSC>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, FCA, FSA, PB extends ModelProperties, OB, FCB, FSB, PC extends ModelProperties, OC, FCC, FSC, PD extends ModelProperties, OD, FCD, FSD>(A: IModelType<PA, OA, FCA, FSA>, B: IModelType<PB, OB, FCB, FSB>, C: IModelType<PC, OC, FCC, FSC>, D: IModelType<PD, OD, FCD, FSD>): ModelUnion<ModelCreationType<PA, FCA> | ModelCreationType<PB, FCB> | ModelCreationType<PC, FCC> | ModelCreationType<PD, FCD>, ModelSnapshotType<PA, FSA> | ModelSnapshotType<PB, FSB> | ModelSnapshotType<PC, FSC> | ModelSnapshotType<PD, FSD>, ModelInstanceType<PA, OA, FCA, FSA> | ModelInstanceType<PB, OB, FCB, FSB> | ModelInstanceType<PC, OC, FCC, FSC> | ModelInstanceType<PD, OD, FCD, FSD>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, FCA, FSA, PB extends ModelProperties, OB, FCB, FSB, PC extends ModelProperties, OC, FCC, FSC, PD extends ModelProperties, OD, FCD, FSD>(options: UnionOptions, A: IModelType<PA, OA, FCA, FSA>, B: IModelType<PB, OB, FCB, FSB>, C: IModelType<PC, OC, FCC, FSC>, D: IModelType<PD, OD, FCD, FSD>): ModelUnion<ModelCreationType<PA, FCA> | ModelCreationType<PB, FCB> | ModelCreationType<PC, FCC> | ModelCreationType<PD, FCD>, ModelSnapshotType<PA, FSA> | ModelSnapshotType<PB, FSB> | ModelSnapshotType<PC, FSC> | ModelSnapshotType<PD, FSD>, ModelInstanceType<PA, OA, FCA, FSA> | ModelInstanceType<PB, OB, FCB, FSB> | ModelInstanceType<PC, OC, FCC, FSC> | ModelInstanceType<PD, OD, FCD, FSD>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, FCA, FSA, PB extends ModelProperties, OB, FCB, FSB, PC extends ModelProperties, OC, FCC, FSC, PD extends ModelProperties, OD, FCD, FSD, PE extends ModelProperties, OE, FCE, FSE>(A: IModelType<PA, OA, FCA, FSA>, B: IModelType<PB, OB, FCB, FSB>, C: IModelType<PC, OC, FCC, FSC>, D: IModelType<PD, OD, FCD, FSD>, E: IModelType<PE, OE, FCE, FSE>): ModelUnion<ModelCreationType<PA, FCA> | ModelCreationType<PB, FCB> | ModelCreationType<PC, FCC> | ModelCreationType<PD, FCD> | ModelCreationType<PE, FCE>, ModelSnapshotType<PA, FSA> | ModelSnapshotType<PB, FSB> | ModelSnapshotType<PC, FSC> | ModelSnapshotType<PD, FSD> | ModelSnapshotType<PE, FSE>, ModelInstanceType<PA, OA, FCA, FSA> | ModelInstanceType<PB, OB, FCB, FSB> | ModelInstanceType<PC, OC, FCC, FSC> | ModelInstanceType<PD, OD, FCD, FSD> | ModelInstanceType<PE, OE, FCE, FSE>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, FCA, FSA, PB extends ModelProperties, OB, FCB, FSB, PC extends ModelProperties, OC, FCC, FSC, PD extends ModelProperties, OD, FCD, FSD, PE extends ModelProperties, OE, FCE, FSE>(options: UnionOptions, A: IModelType<PA, OA, FCA, FSA>, B: IModelType<PB, OB, FCB, FSB>, C: IModelType<PC, OC, FCC, FSC>, D: IModelType<PD, OD, FCD, FSD>, E: IModelType<PE, OE, FCE, FSE>): ModelUnion<ModelCreationType<PA, FCA> | ModelCreationType<PB, FCB> | ModelCreationType<PC, FCC> | ModelCreationType<PD, FCD> | ModelCreationType<PE, FCE>, ModelSnapshotType<PA, FSA> | ModelSnapshotType<PB, FSB> | ModelSnapshotType<PC, FSC> | ModelSnapshotType<PD, FSD> | ModelSnapshotType<PE, FSE>, ModelInstanceType<PA, OA, FCA, FSA> | ModelInstanceType<PB, OB, FCB, FSB> | ModelInstanceType<PC, OC, FCC, FSC> | ModelInstanceType<PD, OD, FCD, FSD> | ModelInstanceType<PE, OE, FCE, FSE>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, FCA, FSA, PB extends ModelProperties, OB, FCB, FSB, PC extends ModelProperties, OC, FCC, FSC, PD extends ModelProperties, OD, FCD, FSD, PE extends ModelProperties, OE, FCE, FSE, PF extends ModelProperties, OF, FCF, FSF>(A: IModelType<PA, OA, FCA, FSA>, B: IModelType<PB, OB, FCB, FSB>, C: IModelType<PC, OC, FCC, FSC>, D: IModelType<PD, OD, FCD, FSD>, E: IModelType<PE, OE, FCE, FSE>, F: IModelType<PF, OF, FCF, FSF>): ModelUnion<ModelCreationType<PA, FCA> | ModelCreationType<PB, FCB> | ModelCreationType<PC, FCC> | ModelCreationType<PD, FCD> | ModelCreationType<PE, FCE> | ModelCreationType<PF, FCF>, ModelSnapshotType<PA, FSA> | ModelSnapshotType<PB, FSB> | ModelSnapshotType<PC, FSC> | ModelSnapshotType<PD, FSD> | ModelSnapshotType<PE, FSE> | ModelSnapshotType<PF, FSF>, ModelInstanceType<PA, OA, FCA, FSA> | ModelInstanceType<PB, OB, FCB, FSB> | ModelInstanceType<PC, OC, FCC, FSC> | ModelInstanceType<PD, OD, FCD, FSD> | ModelInstanceType<PE, OE, FCE, FSE> | ModelInstanceType<PF, OF, FCF, FSF>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, FCA, FSA, PB extends ModelProperties, OB, FCB, FSB, PC extends ModelProperties, OC, FCC, FSC, PD extends ModelProperties, OD, FCD, FSD, PE extends ModelProperties, OE, FCE, FSE, PF extends ModelProperties, OF, FCF, FSF>(options: UnionOptions, A: IModelType<PA, OA, FCA, FSA>, B: IModelType<PB, OB, FCB, FSB>, C: IModelType<PC, OC, FCC, FSC>, D: IModelType<PD, OD, FCD, FSD>, E: IModelType<PE, OE, FCE, FSE>, F: IModelType<PF, OF, FCF, FSF>): ModelUnion<ModelCreationType<PA, FCA> | ModelCreationType<PB, FCB> | ModelCreationType<PC, FCC> | ModelCreationType<PD, FCD> | ModelCreationType<PE, FCE> | ModelCreationType<PF, FCF>, ModelSnapshotType<PA, FSA> | ModelSnapshotType<PB, FSB> | ModelSnapshotType<PC, FSC> | ModelSnapshotType<PD, FSD> | ModelSnapshotType<PE, FSE> | ModelSnapshotType<PF, FSF>, ModelInstanceType<PA, OA, FCA, FSA> | ModelInstanceType<PB, OB, FCB, FSB> | ModelInstanceType<PC, OC, FCC, FSC> | ModelInstanceType<PD, OD, FCD, FSD> | ModelInstanceType<PE, OE, FCE, FSE> | ModelInstanceType<PF, OF, FCF, FSF>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, FCA, FSA, PB extends ModelProperties, OB, FCB, FSB, PC extends ModelProperties, OC, FCC, FSC, PD extends ModelProperties, OD, FCD, FSD, PE extends ModelProperties, OE, FCE, FSE, PF extends ModelProperties, OF, FCF, FSF, PG extends ModelProperties, OG, FCG, FSG>(A: IModelType<PA, OA, FCA, FSA>, B: IModelType<PB, OB, FCB, FSB>, C: IModelType<PC, OC, FCC, FSC>, D: IModelType<PD, OD, FCD, FSD>, E: IModelType<PE, OE, FCE, FSE>, F: IModelType<PF, OF, FCF, FSF>, G: IModelType<PG, OG, FCG, FSG>): ModelUnion<ModelCreationType<PA, FCA> | ModelCreationType<PB, FCB> | ModelCreationType<PC, FCC> | ModelCreationType<PD, FCD> | ModelCreationType<PE, FCE> | ModelCreationType<PF, FCF> | ModelCreationType<PG, FCG>, ModelSnapshotType<PA, FSA>
    | ModelSnapshotType<PB, FSB> | ModelSnapshotType<PC, FSC> | ModelSnapshotType<PD, FSD> | ModelSnapshotType<PE, FSE> | ModelSnapshotType<PF, FSF> | ModelSnapshotType<PG, FSG>, ModelInstanceType<PA,
    OA, FCA, FSA> | ModelInstanceType<PB, OB, FCB, FSB> | ModelInstanceType<PC, OC, FCC, FSC> | ModelInstanceType<PD, OD, FCD, FSD> | ModelInstanceType<PE, OE, FCE, FSE> | ModelInstanceType<PF, OF, FCF, FSF> | ModelInstanceType<PG, OG, FCG, FSG>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, FCA, FSA, PB extends ModelProperties, OB, FCB, FSB, PC extends ModelProperties, OC, FCC, FSC, PD extends ModelProperties, OD, FCD, FSD, PE extends ModelProperties, OE, FCE, FSE, PF extends ModelProperties, OF, FCF, FSF, PG extends ModelProperties, OG, FCG, FSG>(options: UnionOptions, A: IModelType<PA, OA, FCA, FSA>, B: IModelType<PB, OB,
    FCB, FSB>, C: IModelType<PC, OC, FCC, FSC>, D: IModelType<PD, OD, FCD, FSD>, E: IModelType<PE, OE, FCE, FSE>, F: IModelType<PF, OF, FCF, FSF>, G: IModelType<PG, OG, FCG, FSG>): ModelUnion<ModelCreationType<PA, FCA> | ModelCreationType<PB, FCB> | ModelCreationType<PC, FCC> | ModelCreationType<PD, FCD> | ModelCreationType<PE, FCE> | ModelCreationType<PF, FCF> | ModelCreationType<PG, FCG>, ModelSnapshotType<PA, FSA> | ModelSnapshotType<PB, FSB> | ModelSnapshotType<PC, FSC> | ModelSnapshotType<PD, FSD> | ModelSnapshotType<PE, FSE> | ModelSnapshotType<PF, FSF> | ModelSnapshotType<PG, FSG>, ModelInstanceType<PA, OA, FCA, FSA> | ModelInstanceType<PB, OB, FCB, FSB> | ModelInstanceType<PC, OC, FCC, FSC> | ModelInstanceType<PD, OD, FCD, FSD> | ModelInstanceType<PE, OE, FCE, FSE> | ModelInstanceType<PF, OF, FCF, FSF> | ModelInstanceType<PG, OG, FCG, FSG>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, FCA, FSA, PB extends ModelProperties, OB, FCB, FSB, PC extends ModelProperties, OC, FCC, FSC, PD extends ModelProperties, OD, FCD, FSD, PE extends ModelProperties, OE, FCE, FSE, PF extends ModelProperties, OF, FCF, FSF, PG extends ModelProperties, OG, FCG, FSG, PH extends ModelProperties, OH, FCH, FSH>(A: IModelType<PA, OA, FCA, FSA>, B:
    IModelType<PB, OB, FCB, FSB>, C: IModelType<PC, OC, FCC, FSC>, D: IModelType<PD, OD, FCD, FSD>, E: IModelType<PE, OE, FCE, FSE>, F: IModelType<PF, OF, FCF, FSF>, G: IModelType<PG, OG, FCG, FSG>, H: IModelType<PH, OH, FCH, FSH>): ModelUnion<ModelCreationType<PA, FCA> | ModelCreationType<PB, FCB> | ModelCreationType<PC, FCC> | ModelCreationType<PD, FCD> | ModelCreationType<PE, FCE> | ModelCreationType<PF, FCF> | ModelCreationType<PG, FCG> | ModelCreationType<PH, FCH>, ModelSnapshotType<PA, FSA> | ModelSnapshotType<PB, FSB> | ModelSnapshotType<PC, FSC> | ModelSnapshotType<PD, FSD> | ModelSnapshotType<PE, FSE> | ModelSnapshotType<PF, FSF> | ModelSnapshotType<PG, FSG> | ModelSnapshotType<PH, FSH>, ModelInstanceType<PA, OA, FCA, FSA> | ModelInstanceType<PB, OB, FCB, FSB> | ModelInstanceType<PC, OC, FCC, FSC> | ModelInstanceType<PD, OD, FCD, FSD> | ModelInstanceType<PE, OE, FCE, FSE> | ModelInstanceType<PF, OF, FCF, FSF> | ModelInstanceType<PG, OG, FCG, FSG> | ModelInstanceType<PH, OH, FCH, FSH>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, FCA, FSA, PB extends ModelProperties, OB, FCB, FSB, PC extends ModelProperties, OC, FCC, FSC, PD extends ModelProperties, OD, FCD, FSD, PE extends ModelProperties, OE, FCE, FSE, PF extends ModelProperties, OF, FCF, FSF, PG extends ModelProperties, OG, FCG, FSG, PH extends ModelProperties, OH, FCH, FSH>(options: UnionOptions, A: IModelType<PA, OA, FCA, FSA>, B: IModelType<PB, OB, FCB, FSB>, C: IModelType<PC, OC, FCC, FSC>, D: IModelType<PD, OD, FCD, FSD>, E: IModelType<PE, OE, FCE, FSE>, F: IModelType<PF, OF, FCF, FSF>, G: IModelType<PG, OG, FCG, FSG>, H: IModelType<PH, OH, FCH, FSH>): ModelUnion<ModelCreationType<PA, FCA> | ModelCreationType<PB, FCB> | ModelCreationType<PC, FCC> | ModelCreationType<PD, FCD> | ModelCreationType<PE, FCE> | ModelCreationType<PF, FCF> | ModelCreationType<PG, FCG> | ModelCreationType<PH, FCH>, ModelSnapshotType<PA, FSA> | ModelSnapshotType<PB, FSB> | ModelSnapshotType<PC, FSC> | ModelSnapshotType<PD, FSD> | ModelSnapshotType<PE, FSE> | ModelSnapshotType<PF, FSF> | ModelSnapshotType<PG, FSG> | ModelSnapshotType<PH, FSH>, ModelInstanceType<PA, OA, FCA, FSA> | ModelInstanceType<PB, OB, FCB, FSB> | ModelInstanceType<PC, OC, FCC, FSC> | ModelInstanceType<PD, OD, FCD, FSD> | ModelInstanceType<PE, OE, FCE, FSE> | ModelInstanceType<PF, OF, FCF, FSF> | ModelInstanceType<PG, OG, FCG, FSG> | ModelInstanceType<PH, OH, FCH, FSH>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, FCA, FSA, PB extends ModelProperties, OB, FCB, FSB, PC extends ModelProperties, OC, FCC, FSC, PD extends ModelProperties, OD, FCD, FSD, PE extends ModelProperties, OE, FCE, FSE, PF extends ModelProperties, OF, FCF, FSF, PG extends ModelProperties, OG, FCG, FSG, PH extends ModelProperties, OH, FCH, FSH, PI extends ModelProperties, OI, FCI, FSI>(A: IModelType<PA, OA, FCA, FSA>, B: IModelType<PB, OB, FCB, FSB>, C: IModelType<PC, OC, FCC, FSC>, D: IModelType<PD, OD, FCD, FSD>, E: IModelType<PE, OE, FCE, FSE>, F: IModelType<PF, OF, FCF, FSF>, G: IModelType<PG, OG, FCG, FSG>, H: IModelType<PH, OH, FCH, FSH>, I: IModelType<PI, OI, FCI, FSI>): ModelUnion<ModelCreationType<PA, FCA> | ModelCreationType<PB, FCB> | ModelCreationType<PC, FCC> | ModelCreationType<PD, FCD> | ModelCreationType<PE, FCE> | ModelCreationType<PF, FCF> | ModelCreationType<PG, FCG> | ModelCreationType<PH, FCH> | ModelCreationType<PI, FCI>, ModelSnapshotType<PA, FSA> | ModelSnapshotType<PB, FSB> | ModelSnapshotType<PC, FSC> | ModelSnapshotType<PD, FSD> | ModelSnapshotType<PE, FSE> | ModelSnapshotType<PF, FSF> | ModelSnapshotType<PG, FSG> | ModelSnapshotType<PH, FSH> | ModelSnapshotType<PI, FSI>, ModelInstanceType<PA, OA, FCA, FSA> | ModelInstanceType<PB, OB, FCB, FSB> | ModelInstanceType<PC, OC, FCC, FSC> | ModelInstanceType<PD, OD, FCD, FSD>
    | ModelInstanceType<PE, OE, FCE, FSE> | ModelInstanceType<PF, OF, FCF, FSF> | ModelInstanceType<PG, OG, FCG, FSG> | ModelInstanceType<PH, OH, FCH, FSH> | ModelInstanceType<PI, OI, FCI, FSI>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, FCA, FSA, PB extends ModelProperties, OB, FCB, FSB, PC extends ModelProperties, OC, FCC, FSC, PD extends ModelProperties, OD, FCD, FSD, PE extends ModelProperties, OE, FCE, FSE, PF extends ModelProperties, OF, FCF, FSF, PG extends ModelProperties, OG, FCG, FSG, PH extends ModelProperties, OH, FCH, FSH, PI extends ModelProperties, OI, FCI, FSI>(options: UnionOptions, A: IModelType<PA, OA, FCA, FSA>, B: IModelType<PB, OB, FCB, FSB>, C: IModelType<PC, OC, FCC, FSC>, D: IModelType<PD, OD, FCD, FSD>, E: IModelType<PE, OE, FCE, FSE>, F:
    IModelType<PF, OF, FCF, FSF>, G: IModelType<PG, OG, FCG, FSG>, H: IModelType<PH, OH, FCH, FSH>, I: IModelType<PI, OI, FCI, FSI>): ModelUnion<ModelCreationType<PA, FCA> | ModelCreationType<PB, FCB>
    | ModelCreationType<PC, FCC> | ModelCreationType<PD, FCD> | ModelCreationType<PE, FCE> | ModelCreationType<PF, FCF> | ModelCreationType<PG, FCG> | ModelCreationType<PH, FCH> | ModelCreationType<PI, FCI>, ModelSnapshotType<PA, FSA> | ModelSnapshotType<PB, FSB> | ModelSnapshotType<PC, FSC> | ModelSnapshotType<PD, FSD> | ModelSnapshotType<PE, FSE> | ModelSnapshotType<PF, FSF> | ModelSnapshotType<PG, FSG> | ModelSnapshotType<PH, FSH> | ModelSnapshotType<PI, FSI>, ModelInstanceType<PA, OA, FCA, FSA> | ModelInstanceType<PB, OB, FCB, FSB> | ModelInstanceType<PC, OC, FCC, FSC> | ModelInstanceType<PD, OD, FCD, FSD> | ModelInstanceType<PE, OE, FCE, FSE> | ModelInstanceType<PF, OF, FCF, FSF> | ModelInstanceType<PG, OG, FCG, FSG> | ModelInstanceType<PH, OH, FCH, FSH> | ModelInstanceType<PI, OI, FCI, FSI>>
// prettier-ignore
