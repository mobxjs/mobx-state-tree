...
// prettier-ignore
export function union<PA extends ModelProperties, OA, PB extends ModelProperties, OB>(A: IModelType<PA, OA>, B: IModelType<PB, OB>): IComplexType<ModelCreationType<PA> | ModelCreationType<PB>, ModelSnapshotType<PA> | ModelSnapshotType<PB>, ModelInstanceType<PA, OA> | ModelInstanceType<PB, OB>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, PB extends ModelProperties, OB>(options: UnionOptions, A: IModelType<PA, OA>, B: IModelType<PB, OB>): IComplexType<ModelCreationType<PA> | ModelCreationType<PB>, ModelSnapshotType<PA> | ModelSnapshotType<PB>, ModelInstanceType<PA, OA> | ModelInstanceType<PB, OB>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, PB extends ModelProperties, OB, PC extends ModelProperties, OC>(A: IModelType<PA, OA>, B: IModelType<PB, OB>, C: IModelType<PC, OC>): IComplexType<ModelCreationType<PA> | ModelCreationType<PB> | ModelCreationType<PC>, ModelSnapshotType<PA> | ModelSnapshotType<PB> | ModelSnapshotType<PC>, ModelInstanceType<PA, OA> | ModelInstanceType<PB, OB> | ModelInstanceType<PC, OC>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, PB extends ModelProperties, OB, PC extends ModelProperties, OC>(options: UnionOptions, A: IModelType<PA, OA>, B: IModelType<PB, OB>, C: IModelType<PC, OC>): IComplexType<ModelCreationType<PA> | ModelCreationType<PB> | ModelCreationType<PC>, ModelSnapshotType<PA> | ModelSnapshotType<PB> | ModelSnapshotType<PC>, ModelInstanceType<PA, OA> |
    ModelInstanceType<PB, OB> | ModelInstanceType<PC, OC>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, PB extends ModelProperties, OB, PC extends ModelProperties, OC, PD extends ModelProperties, OD>(A: IModelType<PA, OA>, B: IModelType<PB, OB>, C: IModelType<PC, OC>, D: IModelType<PD, OD>): IComplexType<ModelCreationType<PA> | ModelCreationType<PB> | ModelCreationType<PC> | ModelCreationType<PD>, ModelSnapshotType<PA> | ModelSnapshotType<PB> | ModelSnapshotType<PC> | ModelSnapshotType<PD>, ModelInstanceType<PA, OA> | ModelInstanceType<PB, OB> | ModelInstanceType<PC, OC> | ModelInstanceType<PD, OD>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, PB extends ModelProperties, OB, PC extends ModelProperties, OC, PD extends ModelProperties, OD>(options: UnionOptions, A: IModelType<PA, OA>, B: IModelType<PB, OB>, C: IModelType<PC, OC>, D: IModelType<PD, OD>): IComplexType<ModelCreationType<PA> | ModelCreationType<PB> | ModelCreationType<PC> | ModelCreationType<PD>, ModelSnapshotType<PA> | ModelSnapshotType<PB> | ModelSnapshotType<PC> | ModelSnapshotType<PD>, ModelInstanceType<PA, OA> | ModelInstanceType<PB, OB> | ModelInstanceType<PC, OC> | ModelInstanceType<PD, OD>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, PB extends ModelProperties, OB, PC extends ModelProperties, OC, PD extends ModelProperties, OD, PE extends ModelProperties, OE>(A: IModelType<PA, OA>, B: IModelType<PB, OB>, C: IModelType<PC, OC>, D: IModelType<PD, OD>, E: IModelType<PE, OE>): IComplexType<ModelCreationType<PA> | ModelCreationType<PB> | ModelCreationType<PC> | ModelCreationType<PD> | ModelCreationType<PE>, ModelSnapshotType<PA> | ModelSnapshotType<PB> | ModelSnapshotType<PC> | ModelSnapshotType<PD> | ModelSnapshotType<PE>, ModelInstanceType<PA, OA> | ModelInstanceType<PB, OB> | ModelInstanceType<PC, OC> | ModelInstanceType<PD, OD> | ModelInstanceType<PE, OE>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, PB extends ModelProperties, OB, PC extends ModelProperties, OC, PD extends ModelProperties, OD, PE extends ModelProperties, OE>(options: UnionOptions, A: IModelType<PA, OA>, B: IModelType<PB, OB>, C: IModelType<PC, OC>, D: IModelType<PD, OD>, E: IModelType<PE, OE>): IComplexType<ModelCreationType<PA> | ModelCreationType<PB> | ModelCreationType<PC> | ModelCreationType<PD> | ModelCreationType<PE>, ModelSnapshotType<PA> | ModelSnapshotType<PB> | ModelSnapshotType<PC> | ModelSnapshotType<PD> | ModelSnapshotType<PE>, ModelInstanceType<PA, OA> | ModelInstanceType<PB, OB> | ModelInstanceType<PC, OC> | ModelInstanceType<PD, OD> | ModelInstanceType<PE, OE>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, PB extends ModelProperties, OB, PC extends ModelProperties, OC, PD extends ModelProperties, OD, PE extends ModelProperties, OE, PF extends ModelProperties, OF>(A: IModelType<PA, OA>, B: IModelType<PB, OB>, C: IModelType<PC, OC>, D: IModelType<PD, OD>, E: IModelType<PE, OE>, F: IModelType<PF, OF>): IComplexType<ModelCreationType<PA> | ModelCreationType<PB> | ModelCreationType<PC> | ModelCreationType<PD> | ModelCreationType<PE> | ModelCreationType<PF>, ModelSnapshotType<PA> | ModelSnapshotType<PB> | ModelSnapshotType<PC> | ModelSnapshotType<PD> | ModelSnapshotType<PE> | ModelSnapshotType<PF>, ModelInstanceType<PA, OA> | ModelInstanceType<PB, OB> | ModelInstanceType<PC, OC> | ModelInstanceType<PD, OD> | ModelInstanceType<PE, OE> | ModelInstanceType<PF, OF>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, PB extends ModelProperties, OB, PC extends ModelProperties, OC, PD extends ModelProperties, OD, PE extends ModelProperties, OE, PF extends ModelProperties, OF>(options: UnionOptions, A: IModelType<PA, OA>, B: IModelType<PB, OB>, C: IModelType<PC, OC>, D: IModelType<PD, OD>, E: IModelType<PE, OE>, F: IModelType<PF, OF>): IComplexType<ModelCreationType<PA> | ModelCreationType<PB> | ModelCreationType<PC> | ModelCreationType<PD> | ModelCreationType<PE> | ModelCreationType<PF>, ModelSnapshotType<PA> | ModelSnapshotType<PB> | ModelSnapshotType<PC> | ModelSnapshotType<PD> | ModelSnapshotType<PE> | ModelSnapshotType<PF>, ModelInstanceType<PA, OA> | ModelInstanceType<PB, OB> | ModelInstanceType<PC, OC> | ModelInstanceType<PD, OD> | ModelInstanceType<PE, OE> | ModelInstanceType<PF, OF>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, PB extends ModelProperties, OB, PC extends ModelProperties, OC, PD extends ModelProperties, OD, PE extends ModelProperties, OE, PF extends ModelProperties, OF, PG extends ModelProperties, OG>(A: IModelType<PA, OA>, B: IModelType<PB, OB>, C: IModelType<PC, OC>, D: IModelType<PD, OD>, E: IModelType<PE, OE>, F: IModelType<PF, OF>, G: IModelType<PG, OG>): IComplexType<ModelCreationType<PA> | ModelCreationType<PB> | ModelCreationType<PC> | ModelCreationType<PD> | ModelCreationType<PE> | ModelCreationType<PF> | ModelCreationType<PG>, ModelSnapshotType<PA> | ModelSnapshotType<PB> | ModelSnapshotType<PC> | ModelSnapshotType<PD> | ModelSnapshotType<PE> | ModelSnapshotType<PF> | ModelSnapshotType<PG>, ModelInstanceType<PA, OA> | ModelInstanceType<PB, OB> | ModelInstanceType<PC, OC> | ModelInstanceType<PD, OD> | ModelInstanceType<PE, OE> | ModelInstanceType<PF, OF> | ModelInstanceType<PG, OG>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, PB extends ModelProperties, OB, PC extends ModelProperties, OC, PD extends ModelProperties, OD, PE extends ModelProperties, OE, PF extends ModelProperties, OF, PG extends ModelProperties, OG>(options: UnionOptions, A: IModelType<PA, OA>, B: IModelType<PB, OB>, C: IModelType<PC, OC>, D: IModelType<PD, OD>, E: IModelType<PE, OE>, F: IModelType<PF, OF>, G: IModelType<PG, OG>): IComplexType<ModelCreationType<PA> | ModelCreationType<PB> | ModelCreationType<PC> | ModelCreationType<PD> | ModelCreationType<PE> | ModelCreationType<PF> | ModelCreationType<PG>, ModelSnapshotType<PA> | ModelSnapshotType<PB> | ModelSnapshotType<PC> | ModelSnapshotType<PD> | ModelSnapshotType<PE> | ModelSnapshotType<PF> | ModelSnapshotType<PG>, ModelInstanceType<PA, OA> | ModelInstanceType<PB, OB> | ModelInstanceType<PC, OC> | ModelInstanceType<PD, OD> | ModelInstanceType<PE, OE> | ModelInstanceType<PF, OF> | ModelInstanceType<PG, OG>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, PB extends ModelProperties, OB, PC extends ModelProperties, OC, PD extends ModelProperties, OD, PE extends ModelProperties, OE, PF extends ModelProperties, OF, PG extends ModelProperties, OG, PH extends ModelProperties, OH>(A: IModelType<PA, OA>, B: IModelType<PB, OB>, C: IModelType<PC, OC>, D: IModelType<PD, OD>, E: IModelType<PE, OE>, F: IModelType<PF, OF>, G: IModelType<PG, OG>, H: IModelType<PH, OH>): IComplexType<ModelCreationType<PA> | ModelCreationType<PB> | ModelCreationType<PC> | ModelCreationType<PD> | ModelCreationType<PE> | ModelCreationType<PF> | ModelCreationType<PG> | ModelCreationType<PH>, ModelSnapshotType<PA> | ModelSnapshotType<PB> | ModelSnapshotType<PC> | ModelSnapshotType<PD> | ModelSnapshotType<PE> | ModelSnapshotType<PF> | ModelSnapshotType<PG> | ModelSnapshotType<PH>, ModelInstanceType<PA, OA> | ModelInstanceType<PB, OB> | ModelInstanceType<PC, OC> | ModelInstanceType<PD, OD> | ModelInstanceType<PE, OE> | ModelInstanceType<PF, OF> | ModelInstanceType<PG, OG> | ModelInstanceType<PH, OH>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, PB extends ModelProperties, OB, PC extends ModelProperties, OC, PD extends ModelProperties, OD, PE extends ModelProperties, OE, PF extends ModelProperties, OF, PG extends ModelProperties, OG, PH extends ModelProperties, OH>(options: UnionOptions, A: IModelType<PA, OA>, B: IModelType<PB, OB>, C: IModelType<PC, OC>, D: IModelType<PD, OD>, E: IModelType<PE, OE>, F: IModelType<PF, OF>, G: IModelType<PG, OG>, H: IModelType<PH, OH>): IComplexType<ModelCreationType<PA> | ModelCreationType<PB> | ModelCreationType<PC> | ModelCreationType<PD> | ModelCreationType<PE> | ModelCreationType<PF> | ModelCreationType<PG> | ModelCreationType<PH>, ModelSnapshotType<PA> | ModelSnapshotType<PB> | ModelSnapshotType<PC> | ModelSnapshotType<PD> | ModelSnapshotType<PE> | ModelSnapshotType<PF> | ModelSnapshotType<PG> | ModelSnapshotType<PH>, ModelInstanceType<PA, OA> | ModelInstanceType<PB, OB> | ModelInstanceType<PC, OC> | ModelInstanceType<PD, OD> | ModelInstanceType<PE, OE> | ModelInstanceType<PF, OF> | ModelInstanceType<PG, OG> | ModelInstanceType<PH, OH>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, PB extends ModelProperties, OB, PC extends ModelProperties, OC, PD extends ModelProperties, OD, PE extends ModelProperties, OE, PF extends ModelProperties, OF, PG extends ModelProperties, OG, PH extends ModelProperties, OH, PI extends ModelProperties, OI>(A: IModelType<PA, OA>, B: IModelType<PB, OB>, C: IModelType<PC, OC>, D: IModelType<PD, OD>, E: IModelType<PE, OE>, F: IModelType<PF, OF>, G: IModelType<PG, OG>, H: IModelType<PH, OH>, I: IModelType<PI, OI>): IComplexType<ModelCreationType<PA> | ModelCreationType<PB> | ModelCreationType<PC> | ModelCreationType<PD> | ModelCreationType<PE> | ModelCreationType<PF> | ModelCreationType<PG> | ModelCreationType<PH> | ModelCreationType<PI>, ModelSnapshotType<PA> | ModelSnapshotType<PB> | ModelSnapshotType<PC> | ModelSnapshotType<PD> | ModelSnapshotType<PE> | ModelSnapshotType<PF> | ModelSnapshotType<PG> | ModelSnapshotType<PH> | ModelSnapshotType<PI>, ModelInstanceType<PA, OA> | ModelInstanceType<PB, OB> | ModelInstanceType<PC, OC> | ModelInstanceType<PD, OD> | ModelInstanceType<PE, OE> | ModelInstanceType<PF, OF> | ModelInstanceType<PG, OG> | ModelInstanceType<PH, OH> | ModelInstanceType<PI, OI>>
// prettier-ignore
export function union<PA extends ModelProperties, OA, PB extends ModelProperties, OB, PC extends ModelProperties, OC, PD extends ModelProperties, OD, PE extends ModelProperties, OE, PF extends ModelProperties, OF, PG extends ModelProperties, OG, PH extends ModelProperties, OH, PI extends ModelProperties, OI>(options: UnionOptions, A: IModelType<PA, OA>, B: IModelType<PB, OB>, C: IModelType<PC, OC>, D: IModelType<PD, OD>, E: IModelType<PE, OE>, F: IModelType<PF, OF>, G: IModelType<PG, OG>, H: IModelType<PH, OH>, I: IModelType<PI, OI>): IComplexType<ModelCreationType<PA> | ModelCreationType<PB> | ModelCreationType<PC> | ModelCreationType<PD> | ModelCreationType<PE> | ModelCreationType<PF> | ModelCreationType<PG> | ModelCreationType<PH> | ModelCreationType<PI>, ModelSnapshotType<PA> | ModelSnapshotType<PB> | ModelSnapshotType<PC> | ModelSnapshotType<PD> | ModelSnapshotType<PE> | ModelSnapshotType<PF> | ModelSnapshotType<PG> | ModelSnapshotType<PH> | ModelSnapshotType<PI>, ModelInstanceType<PA, OA> | ModelInstanceType<PB, OB> | ModelInstanceType<PC, OC> | ModelInstanceType<PD, OD> | ModelInstanceType<PE, OE> | ModelInstanceType<PF, OF> | ModelInstanceType<PG, OG> | ModelInstanceType<PH, OH> | ModelInstanceType<PI, OI>>
// prettier-ignore
