-   Added `getNodeId` to get the internal unique node id for an instance [#1168](https://github.com/mobxjs/mobx-state-tree/issues/1168) through []() by [@xaviergonz](https://github.com/xaviergonz)
