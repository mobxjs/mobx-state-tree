-   Fixed an issue where `map.put` would not work with snapshots of types with an optional id [#1131](https://github.com/mobxjs/mobx-state-tree/issues/1131) through []() by [@xaviergonz](https://github.com/xaviergonz).
